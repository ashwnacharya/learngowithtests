...
import (
	...
	"log"
	"net"
	"github.com/ashwnacharya/go-specs-greet/adapters/grpcserver"
	"github.com/ashwnacharya/go-specs-greet/domain/interactions"
...
func (g GreetServer) Curse(ctx context.Context, request *grpcserver.GreetRequest) (*grpcserver.GreetReply, error) {
	return &grpcserver.GreetReply{Message: interactions.Curse(request.Name)}, nil
}