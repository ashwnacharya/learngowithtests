...
func (m *IngredientMutation) SetQuantity(u uint) {
	m.quantity = &u
	m.addquantity = nil
}

// Quantity returns the value of the "quantity" field in the mutation.
func (m *IngredientMutation) Quantity() (r uint, exists bool) {
	v := m.quantity
	if v == nil {
		return
	}
...
// If the Ingredient object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *IngredientMutation) OldQuantity(ctx context.Context) (v uint, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *IngredientMutation) AddQuantity(u int) {
...
func (m *IngredientMutation) AddedQuantity() (r int, exists bool) {
	v := m.addquantity
	if v == nil {
		return
	}
